...
export const monitoringIds = keysAreSameAsValuesCheck({
  ...
  GOTO_PLAYER_ATTENDANCE: "GOTO_PLAYER_ATTENDANCE",

  GOTO_PLAYER_PURCHASES: "GOTO_PLAYER_PURCHASES",

  GOTO_PLAYER_ADJUSTMENTS: "GOTO_PLAYER_ADJUSTMENTS",

  GOTO_CHARACTER: "GOTO_CHARACTER",

  GOTO_RAID_ACTIVITIES: "GOTO_RAID_ACTIVITIES",

  GOTO_RAID_ACTIVITY_SUMMARY: "GOTO_RAID_ACTIVITY_SUMMARY",
  ...
  GOTO_EQDKP_CHARACTER: "GOTO_EQDKP_CHARACTER",
