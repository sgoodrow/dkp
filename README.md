...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create dkp-cc05
  fly apps create dkp-cc05-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app dkp-cc05
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app dkp-cc05-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'dkp-cc05-staging' does not match app name in config file 'dkp-cc05'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name dkp-cc05-db
  fly postgres attach --app dkp-cc05 dkp-cc05-db

  fly postgres create --name dkp-cc05-staging-db
  fly postgres attach --app dkp-cc05-staging dkp-cc05-staging-db
  ```
